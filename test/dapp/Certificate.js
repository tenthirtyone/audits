...
contract('IGVCertificate Test', accounts => {
  ...
  describe('IGVCertificate', () => {
    ...
    describe('Certificate', async () => {
      ...
      it('Creates a donate any amount certificate', async () => {
        await dapp.createCertificate(1, 10, "Test Certificate", 0);
      })
    ...
    describe('Fail conditions', async () => {
      ...
      it('Cannot create a new certificate without a supply', async () => {
        await assertRevert(dapp.createCertificate(1, 0, "Test Certificate", 10, {from: mallory}));
      })
